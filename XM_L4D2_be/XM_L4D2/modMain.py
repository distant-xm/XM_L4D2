...
class XM_L4D2(object):
    ...
    def XMServerSystem(self):
        ...
        serverApi.RegisterSystem(config.ModName, config.ServerSystemName, config.ServerSystemClsPath)
    ...
    def XMClientSystem(self):
        ...
        clientApi.RegisterSystem(config.ModName, config.ClientSystemName, config.ClientSystemClsPath)
